...
class AppSettings {
    constructor(clientConfig) {
        ...
        // Special case: /graph/3d should use 'public' as default, not '3d'
        const validNetwork = networkFromUrl === '3d' ? 'public' : networkFromUrl
        setStellarNetwork(validNetwork || Object.keys(this.networks)[0])
    }
