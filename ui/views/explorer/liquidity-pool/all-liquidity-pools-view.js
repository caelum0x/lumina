...
export default function AllLiquidityPoolsView() {
    ...
    return <>
        ...
        <div className="segment blank">
            ...
            {loaded && pools.data && pools.data.length === 0 && (
                <div className="text-center dimmed space">
                    <p>No liquidity pools found on the network.</p>
                    <p className="text-small">Liquidity pools may not be available or the network has no active pools.</p>
                </div>
            )}
            {loaded && pools.data && pools.data.length > 0 && <div className="micro-space">
