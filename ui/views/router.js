            ...
            <Route>
                <Layout menu={<TopMenu/>}>
                    <Switch>
                        ...
                        {/*settings*/}
                        <Route path="/settings">
                            <Loadable moduleKey="user-settings"
                                      load={() => import(/* webpackChunkName: "settings" */ './components/user-settings')}/>
                        </Route>
                        {/*demolisher*/}
                        ...
                        <Route path="/graph/3d/:network?">
                            <Loadable moduleKey="three-graph"
                                      load={() => import(/* webpackChunkName: "graph" */ './graph/three-graph-router')}/>
                        </Route>
                        {/*not found*/}
