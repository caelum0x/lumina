...
module.exports = function (app) {
    // Asset list endpoint - DISABLED, using horizon-fallback-routes instead
    // registerRoute(app,
    //     'asset',
    ...
    registerRoute(app,
        ...
        {cache: 'global-stats'},
        async ({params}) => {
            const response = await fetch(`https://api.stellar.expert/explorer/${params.network}/asset-stats/overall`)
    ...
    registerRoute(app,
        ...
        ({params, req}) => queryAssetsMeta(params.network, req.path, req.query))
