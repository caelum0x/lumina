...
module.exports = function (app) {
    ...
    // Legacy route: contract/:contract/versions (kept for backward compatibility)
    // Use contract/:contract/version instead
    registerRoute(app,
    ...
    // Legacy route: contract/wasm/:hash (kept for backward compatibility)
    registerRoute(app,
        'contract/wasm/:hash',
        {cache: 'stats'},
        async ({params}, res) => {
